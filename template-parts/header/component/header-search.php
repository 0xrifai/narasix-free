...
<div id="nsix-search-modal" class="modal">
  <div class="modal-dialog md:w-[35rem]">
    <div class="dark:divide-charcoal-800/40 bg-charcoal-100 dark:bg-charcoal-700 h-[30rem] divide-y rounded-t-lg p-0 shadow-lg outline-0 sm:h-auto sm:rounded-xl">
